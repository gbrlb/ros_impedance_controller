...
namespace ros_impedance_controller
{
     ...
     class Controller_TaskSpace : public controller_interface::MultiInterfaceController<hardware_interface::EffortJointInterface>
     {
     public:
          /** @brief Constructor function */
          Controller_TaskSpace();
     ...
     PLUGINLIB_EXPORT_CLASS(ros_impedance_controller::Controller_TaskSpace, controller_interface::ControllerBase);
